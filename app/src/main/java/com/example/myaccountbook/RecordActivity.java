...
//        // 이전에 저장된 상태가 있는지 확인하고 복원
//        if (savedInstanceState != null) {
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
//                가계부 = savedInstanceState.getSerializable("accountBook",accountBook.class);
//            }
//            else{
//                가계부 = new accountBook();
//            }
//            // 저장된 카운터 값을 복원하여 사용
//            // 필요한 다른 데이터들도 같은 방식으로 복원 가능
//        }
//        else{
//            가계부 = new accountBook();
//        }
...
//                Toast.makeText(RecordActivity.this, "선택된 항목: " + selectedItem, Toast.LENGTH_SHORT).show();
        ...
        날짜의년월.setText(년월일.format(calendar.getTime()));
...
//                            반복버튼.setCompoundDrawablesWithIntrinsicBounds(drawables[0], drawables[1], drawableRight, drawables[3]);
        ...
        날짜의시분.setText(시분.format(calendar.getTime()));
        ...
        반복버튼.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RecordActivity.this, SelectRoutineActivity.class);
        ...
        자산종류.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecordActivity.this, AssetActivity.class);
...
//                startActivityIfNeeded(intent,REQUEST_ASSET);
        ...
        사진선택.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //PopupMenu 객체 생성
                PopupMenu popup= new PopupMenu(RecordActivity.this, v); //두 번째 파라미터가 팝업메뉴가 붙을 뷰
...
//                            Toast.makeText(RecordActivity.this, "Option 2 selected", Toast.LENGTH_SHORT).show();
        ...
        NumberTextWatcher textWatcher = new NumberTextWatcher(금액);
...
//                    가계부.이미지3 = 이미지경로.get(2);
                ...
                if(result != -1){
                    ...
                    resultIntent.putExtra("accountBook", 가계부);
    ...
    private void saveImage(Uri selectedImageUri) throws IOException {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RecordActivity.this,ImagePageActivity.class);
...
//        // 액티비티가 종료될 때 상태를 저장
//        outState.putSerializable("accountBook", 가계부);
//        super.onSaveInstanceState(outState);
//    }

//    private Date getTime(){
//        가계부날짜 = System.currentTimeMillis();
//        long mNow = 가계부날짜;
...
//        // 뒤로가기 버튼 또는 Toolbar의 뒤로가기 아이콘을 클릭했을 때의 동작
//        // 원하는 동작 수행
//        Toast.makeText(this, "뒤로가기 버튼 클릭됨", Toast.LENGTH_SHORT).show();
//        super.onBackPressed();
//    }
